...
int main(int argc, char* argv[]) {
  ...
  // 1. Use unstructured data construct to copy in Matrices h_A and h_B, and create gpu_C 

  openacc_matrix_mult(h_A, h_B, gpu_C, rowsA, colsB, rowsB);

  // 2. Use unstructed data construct to copyout gpu_C and delete h_A and h_B
