...
program miniweather
  ...
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  !! TODO: Add vars for local MPI communicators to manage multi-GPU nodes
  integer  :: local_comm, local_rank              !Local comm and rank in MPI for multi-GPU nodes
  !! TODO: Add var to store number of GPUs per node
  integer  :: nGPUs_node
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
contains
  ...
  subroutine set_halo_values_x(state)
    ...
    !Prepost receives
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    !! TODO: Specify the receive buffers to reference GPU device memory using OpenACC
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    !Fire off the sends
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    !! TODO: Specify the send buffers to reference GPU device memory using OpenACC
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine init(dt)
    ...
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    !! BEGIN MPI SECTION
    !! TODO: (1) Add MPI_Comm_split_type to create a *local_comm* per node
    !!       (2) Get the *local_rank* for each MPI task from each local communicator
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    call MPI_Init(ierr)
    ...
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    !! TODO: Set the GPU device for each MPI process per its *local_rank* on a node
    !! See section 3.2 Runtime Library Routines of openacc.org/sites/default/files/inline-images/Specification/OpenACC-3.2-final.pdf
    #ifdef _OPENACC
