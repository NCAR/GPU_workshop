...
if(COMMAND_ARGUMENT_COUNT().EQ.0) then
   ...
   call GET_COMMAND_ARGUMENT(2,maxIterChar)
   read(nVertLevelsChar,*)nVertLevels
   read(nCellsChar,*)nCells
   read(maxIterChar,*)maxIter
else
...
! Repeat run simulations of the kernels to ensure meaningful profiler measurements
do iter = 1, maxIter

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!
!!! OPTIMIZE and MODIFY kernel configurations below
!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
!DIR$ IVDEP
         do k=1,nVertLevels
            cofwt(k,iCell) = .5*dtseps*rcv*zz(k,iCell)*gravity*rb(k,iCell)/(1.+qtot(k,iCell))  &
